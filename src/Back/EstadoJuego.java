...
public class EstadoJuego {
    ...
    private final PalabraAnotada casillasJugadasEsteTurno;
    private final ArrayList<PalabraAnotada> palabrasAnotadas;
    private final ArrayList<String> palabrasAnotadasUltimoTurno;
    ...
    public ArrayList<String> getPalabraAnotadaUltimoTurno() {
        return palabrasAnotadasUltimoTurno;
    }
    
    public void setEstadoJuego(int nuevoEstadoJuego) {
        estadoJuegoActual = nuevoEstadoJuego;
    }
    ...
    public boolean añadirCasillaJugada(Casilla casilla) {
        return casillasJugadasEsteTurno.add(casilla);
    }

    public boolean eliminarCasillaJugada(Casilla casilla) {
        return casillasJugadasEsteTurno.remove(casilla);
    }
